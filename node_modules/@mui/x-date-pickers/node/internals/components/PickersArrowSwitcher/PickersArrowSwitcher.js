...
const PickersArrowSwitcher = /*#__PURE__*/React.forwardRef(function PickersArrowSwitcher(inProps, ref) {
  ...
  const LeftArrowIcon = slots?.leftArrowIcon ?? components?.LeftArrowIcon ?? _icons.ArrowLeft;
  ...
  const RightArrowIcon = slots?.rightArrowIcon ?? components?.RightArrowIcon ?? _icons.ArrowRight;
  // The spread is here to avoid this bug mui/material-ui#34056
