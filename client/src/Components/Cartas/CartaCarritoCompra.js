...
export default function CartaCarritoCompra({id, name, image, price, quantity}) {
    ...
    const takeOfCartLocalStorage = (id, name, price) => {
        ...
        // console.log(cartItems)
                 ...
                 const restarAcarrito=()=>{
                    takeOfCartLocalStorage(id, name, price);
    ...
    return (
        ...
        <div className='cards-carrito-previsualizacion'>
            ...
            <div className='zona-info-plato-carrito-previsualizacion'>
                ...
                <button className="boton-agregar-uno-mas-carrito-previsualizacion-izquierda" onClick={restarAcarrito}>-</button>
