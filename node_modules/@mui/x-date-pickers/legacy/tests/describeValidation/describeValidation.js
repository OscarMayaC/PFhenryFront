...
var TEST_SUITES = [testYearViewValidation, testMonthViewValidation, testDayViewValidation, testTextFieldValidation];
 ...
 */
export var describeValidation = createDescribe('Pickers validation API', innerDescribeValidation);